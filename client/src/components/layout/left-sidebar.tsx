    ...
    <aside className="hidden lg:block w-56 flex-shrink-0">
      <div className="bg-white rounded-lg border border-light-border p-4 mb-4">
        ...
        <div className="space-y-2">
          {communities?.slice(0, 5).map((community) => (
            <Link key={community.id} href={`/r/${community.name}`}>
              <a className="flex items-center p-2 rounded-md hover:bg-light">
                <div 
          ...
          {!communities && (
            <>
              <div className="flex items-center p-2 rounded-md hover:bg-light">
                <div 
                  className="community-icon mr-2" 
        ...
        <Link href="/communities">
          <a className="text-secondary hover:underline text-sm block mt-4">View All Communities</a>
        </Link>
      </div>
      ...
      <div className="bg-white rounded-lg border border-light-border p-4">
        ...
        <ul className="space-y-2">
          <li>
            <Link href="/">
              <a className="text-neutral-dark hover:text-primary flex items-center">
